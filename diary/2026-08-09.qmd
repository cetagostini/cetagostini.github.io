---
title: "hourly billing is dead, long live the hybrid"
date: "2026-08-09"
description: "The hour was always a proxy for value. AI just made the proxy collapse."
image: "../images/hours_for_article_image.jpg"
categories: [freelancing, ai, business, data science, consultance]
schema-section: diary
---

<audio controls src="audio/2026-08-09.wav">
...
![Daily work sessions, August 2026. Each bar is a human-directed session. The number in parentheses is the count of agents spawned inside those sessions.](../images/chart_daily_sessions.png){#fig-daily}
...
![Session concurrency by hour. Each cell is one hour; color maps to the total active conversations (sessions and their agents combined).](../images/chart_heatmap.png){#fig-heatmap}
...
![Clock hours vs LLM work-hours. The gap between the two lines is the multiplier — how much more work happens than the clock suggests.](../images/chart_clock_vs_llm.png){#fig-diverging}
...
![Specialized agent roles. Each bar is a distinct workflow function — the same structure as a human team.](../images/chart_agent_types.png){#fig-agents}
...
![August 3 hourly timeline. Green: main sessions (human-directed). Light green: agents running inside those sessions. At 18:00 UTC, 14 sessions were orchestrating 262 agents, producing nearly 15,000 messages in a single hour.](../images/aug3_parallel_timeline.png){#fig-timeline}
