...
::: {.article-content}
::: {.article-meta}
[MMM]{.topic-chip} [Synthetic]{.topic-chip} [August 2026]{.date}
:::

### [Custom Article](articles/custom-article/custom-article.html)

A placeholder article using prior-generator synthetic data for MMM estimation experiments.
...
- [Custom Article](articles/custom-article/custom-article.html) - _August 2026_
