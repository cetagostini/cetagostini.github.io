...
::: {.article-content}
::: {.article-meta}
[Bayesian]{.topic-chip} [Causal]{.topic-chip} [Discovery]{.topic-chip} [August 2026]{.date}
:::
...
[Read More](articles/bayesian_cpdag_graph_discovery/bayesian_cpdag_graph_discovery.html){.btn .btn-outline-primary}
:::

::: {.article-image-container}
<img src="images/bayesian_cpdag_graph_discovery.png" alt="Several causal graph equivalence classes receiving different amounts of posterior probability.">
:::
::::
...
- [A Causal Graph Is Not One Graph: Bayesian Discovery with CPDAG Posteriors](articles/bayesian_cpdag_graph_discovery/bayesian_cpdag_graph_discovery.html) - _August 2026_
