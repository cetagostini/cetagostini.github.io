...
::: {.article-content}
::: {.article-meta}
[MMM]{.topic-chip} [PyMC-Marketing]{.topic-chip} [August 2026]{.date}
:::
...
[Read More](articles/custom-article/custom-article.html){.btn .btn-outline-primary}
:::

::: {.article-image-container}
<img src="articles/custom-article/custom-article_files/figure-html/fig-route-map-output-1.png" alt="Caracas and Valencia media channels connected by three cross-city spill routes">
:::
::::
...
- [Media Does Not Stop at the City Border: Cross-City Spillovers with PyMC-Marketing](articles/custom-article/custom-article.html) - _August 2026_
