...
::: {.article-content}
::: {.article-meta}
[Causal]{.topic-chip} [BSTS]{.topic-chip} [Bayesian]{.topic-chip} [August 2026]{.date}
:::

### [Free Transit for All: Did Tallinn's Experiment Actually Work?](articles/tallinn_free_transit/tallinn_free_transit.html)

A Bayesian Structural Time Series causal impact analysis of Tallinn's 2013 free transit policy, using synthetic control from Estonian counties and European cities.

[Read More](articles/tallinn_free_transit/tallinn_free_transit.html){.btn .btn-outline-primary}
:::

::: {.article-image-container}
<img src="articles/tallinn_free_transit/images/tallinn_free_transit.png" alt="Tallinn skyline with bus routes overlaid, showing a causal impact diagram with pre and post intervention periods">
:::
::::
...
- [Free Transit for All: Did Tallinn's Experiment Actually Work?](articles/tallinn_free_transit/tallinn_free_transit.html) - _August 2026_
