...
We walk through a concrete example of this process — turning experimental results into calibrated model parameters — in [From Experiments to Priors: Calibrating Your Marketing Mix Model](../calibrating_mmm_with_experiments/calibrating_mmm_with_experiments.qmd).
:::
...
# Sensitivity analysis: when scale breaks symmetry
...
for k in scale_factors:
    ...
    print(f"k={k:2d} | Avg: {res_avg.x.round(1)} | Robust: {res_rob.x.round(1)}")
```
