---
title: "From Experiments to Priors: Eliciting Informative Priors for Your Marketing Mix Model"
author: "Carlos Trujillo"
date: "2026-02-08"
description: "How to translate quasi-experimental results into informative Bayesian priors for your MMM using CausalPy and PyMC-Marketing."
categories: [MMM, python, prior elicitation, experimentation, media mix modeling, bayesian, pymc, causalpy, synthetic control]
image: "/images/from_experiments_to_priors.jpg"
image-alt: "Flow diagram showing how quasi-experimental results are translated into Bayesian priors for marketing mix models"
jupyter: from_experiments_to_priors
format:
  html:
    code-fold: false
    code-tools: true
...
::: {.callout-important title="Prior elicitation vs likelihood calibration"}
...
```{dot}
//| fig-cap: "Causal structure of the quasi-experiment"
//| echo: false
digraph G {
    rankdir=TB
    ...
    VE_Exog [label="Venezuela\nExogenous" style=dashed]
    CO_Exog [label="Colombia\nExogenous" style=dashed]

    Shared -> VE_Sales [style=dashed]
    Shared -> CO_Sales [style=dashed]
    VE_Exog -> VE_Sales [style=dashed]
    CO_Exog -> CO_Sales [style=dashed]
    Treatment -> VE_Spend
    VE_Spend -> VE_Sales
}
```
...
::: {.callout-warning title="Assumption: stationary counterfactual spend"}
...
::: {.callout-warning title="Theoretical nuance: Secant vs Tangent"}
...
::: {.callout-warning title="Raw spend vs adstocked spend"}
...
::: {.callout-important title="The Identification Problem"}
