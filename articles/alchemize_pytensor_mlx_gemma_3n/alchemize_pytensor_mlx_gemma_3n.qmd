...
date: "2026-07-12"
description: "What PyTensor is missing for LLM inference—and how straightforward it is to build. A Python-native exploration of symbolic graphs, GGUF weights, multiple backends, and the path from here to a composable LLM runtime."
aliases:
  - gemma3n_e4b_symbolic_pytensor_inference.html
categories: [python, pytensor, mlx, numba, llm, gguf, gemma]
image: "../../images/pytensor_llm_inference.svg"
execute:
  eval: false
  freeze: false
format:
