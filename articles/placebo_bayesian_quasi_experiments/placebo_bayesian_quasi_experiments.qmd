...
date: "2026-04-07"
description: "A Bayesian framework using placebo tests and ROPE-based inference to audit whether your quasi-experimental causal estimates are trustworthy."
author:
    - name: Carlos Trujillo
    - name: Anton Bugaev
categories: [python, experimentation, quasi-experiments, bayesian, pymc]
image: "../images/placebo_bayesian_quasi_experiments.jpg"
image-alt: "Diagram showing a Bayesian placebo test framework for auditing quasi-experimental causal estimates"
jupyter: placebo_bayesian_quasi_experiments
format:
  html:
    code-fold: true
    code-tools: true
