...
#| fig-alt: "A route diagram with Caracas channels Facebook and Google Search pointing to Valencia sales, Valencia channel Linear TV pointing to Caracas sales, and local-only channels shown with dotted outlines."
#| code-fold: true
#| warning: false
