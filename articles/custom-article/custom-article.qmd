...
image: ../images/custom-article.png
...
#| fig-cap: "Caracas and Valencia are 124.9 km apart. Broadcast, search, and ecommerce mechanisms can carry media effects across that corridor."
...
::: {.callout-note}
## Source and license
Map data: [Natural Earth](https://www.naturalearthdata.com/about/terms-of-use/) 1:110m Admin 0 countries. Caracas (10.48\u00b0 N, 66.90\u00b0 W) and Valencia (10.16\u00b0 N, 68.01\u00b0 W) are approximately 124.9 km apart by straight line.
:::
...
```{python}
#| label: fig-route-map
#| fig-cap: "Two Pearl-style causal DAGs. Left: two isolated city MMMs — media converts only inside its own city. Right: the connected model — three green cross-city edges carry exactly 10% of the source channel's true contribution into the other city's target."
#| fig-alt: "Two directed acyclic graphs. The left shows two isolated boxes for Caracas and Valencia, each with observed media spend flowing through unobserved response to observed sales. The right duplicates the structure but adds three green arrows crossing the city boundary from Caracas Facebook and Google Search to Valencia Y, and from Valencia Linear TV to Caracas Y."
#| code-fold: true
#| warning: false
import graphviz
