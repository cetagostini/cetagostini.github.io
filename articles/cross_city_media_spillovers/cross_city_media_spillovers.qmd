...
$$
Y_{r,t}=\mu^{\text{direct}}_{r,t}+S_{r,t}+\epsilon_{r,t}.
$$

Here $S_{r,t}$ is the spill arriving in receiving city $r$: a bounded share of an eligible source city's already-computed direct contribution. The direct city-level MMM is otherwise unchanged.
