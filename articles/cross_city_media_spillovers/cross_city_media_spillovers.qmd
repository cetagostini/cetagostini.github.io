...
#| fig-cap: "The Caracas–Valencia corridor, roughly 124.9 km end to end. Broadcast, search, and ecommerce are the kinds of mechanism that could carry media effects across a corridor like this one."
...
\begin{aligned}
Y_{r,t}
&= \beta_{r} + \mu^{\text{direct}}_{r,t} + S_{r,t} + C_{r,t} + \epsilon_{r,t}, \\
S_{r,t}
&= \sum_{s\neq r}\sum_{k=1}^{K}
M_{r,s,k}\,\rho_{s,k} \\
