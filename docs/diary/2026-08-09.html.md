...
<figure><img src="../images/chart_daily_sessions.png" class="img-fluid figure-img" alt="Figure 1: Daily work sessions, August 2026. Each bar is a human-directed session. The number in parentheses is the count of agents spawned inside those sessions." /><figcaption aria-hidden="true">Figure 1: Daily work sessions, August 2026. Each bar is a human-directed session. The number in parentheses is the count of agents spawned inside those sessions.</figcaption></figure>
...
<figure><img src="../images/chart_heatmap.png" class="img-fluid figure-img" alt="Figure 2: Session concurrency by hour. Each cell is one hour; color maps to the total active conversations (sessions and their agents combined)." /><figcaption aria-hidden="true">Figure 2: Session concurrency by hour. Each cell is one hour; color maps to the total active conversations (sessions and their agents combined).</figcaption></figure>
...
<figure><img src="../images/chart_clock_vs_llm.png" class="img-fluid figure-img" alt="Figure 3: Clock hours vs LLM work-hours. The gap between the two lines is the multiplier — how much more work happens than the clock suggests." /><figcaption aria-hidden="true">Figure 3: Clock hours vs LLM work-hours. The gap between the two lines is the multiplier — how much more work happens than the clock suggests.</figcaption></figure>
...
<figure><img src="../images/chart_agent_types.png" class="img-fluid figure-img" alt="Figure 4: Specialized agent roles. Each bar is a distinct workflow function — the same structure as a human team." /><figcaption aria-hidden="true">Figure 4: Specialized agent roles. Each bar is a distinct workflow function — the same structure as a human team.</figcaption></figure>
...
<figure><img src="../images/aug3_parallel_timeline.png" class="img-fluid figure-img" alt="Figure 5: August 3 hourly timeline. Green: main sessions (human-directed). Light green: agents running inside those sessions. At 18:00 UTC, 14 sessions were orchestrating 262 agents, producing nearly 15,000 messages in a single hour." /><figcaption aria-hidden="true">Figure 5: August 3 hourly timeline. Green: main sessions (human-directed). Light green: agents running inside those sessions. At 18:00 UTC, 14 sessions were orchestrating 262 agents, producing nearly 15,000 messages in a single hour.</figcaption></figure>
